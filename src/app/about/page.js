...
export default function AboutPage() {
  return (
    <div className="about-container">
      <h1>Anniime Recommendations</h1>
      <h2>About Me</h2>
      <section className="about-me">
        <p>
          Hi there! I'm Ace Chianní (she/her), a New Orleans-based creative with
          a love for art, anime, gaming, and all things nerdy. I’m driven by a
          passion for crafting meaningful, engaging experiences that merge
          creativity with technology. Whether it’s through design, storytelling,
          or exploration, my goal is to create impactful, immersive works that
          inspire and connect. As I transition into the tech space, I’m excited
          to bring fresh, innovative ideas to life and share my journey of
          discovery and creation with the world.
        </p>
      </section>
      ...
      <section className="why">
        <p>
          ...
          creativity and technology. It’s a space where I can showcase my design
          and development skills while sharing my love for anime with the world.
          This project is a step toward my dream of becoming a freelance artist
          and entrepreneur, traveling the world, and inspiring others through my
          work.
        </p>
      </section>
    </div>
